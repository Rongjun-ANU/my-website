...
\begin{enumerate}
	...
	\begin{itemize} 
      \item[] {\bf Rongjun Huang}, Luca Cortese, Barbara Catinella, Luke J. M. Davies, Toby Brown, Andrei Ristea, Alessandro Boselli, Andrew J. Battisti, Vicente Villanueva, Kristine Spekkens, Sara L. Ellison, Daniel A. Dale, Sabine Thater \& Amirnezam Amiri. \textbf{2026}. \\
      (submitted).
  \end{itemize}
	...
	\begin{itemize} 
      ...
      MNRAS (Accepted).  \href{https://doi.org/10.1093/mnras/stag185}{\bf DOI: 10.1093/mnras/stag185}.
  \end{itemize}
...
{\bf NCI / Gadi}
	\begin{itemize}
      \item[] Star Formation and Feedback in a Turbulent Interstellar Medium (Project jh2; PI: Mark Krumholz). \hfill 2023-present.
  \end{itemize}

{\bf Pawsey / Setonix}
	\begin{itemize}
      \item[] Multiphase Astrophysics to Unveil the Virgo Environment (Pawsey1308; PI: Luca Cortese). \hfill 2026-present.
      \item[] Star Formation and Feedback in a Turbulent Interstellar Medium (Pawsey0807; PI: Mark Krumholz). \hfill 2023-present.
      
  \end{itemize}

{\bf Swinburne / OzSTAR}
	\begin{itemize}
      \item[] IFS Data Analysis (oz084; PI: Luca Cortese). \hfill 2025-present.
      \item[] Anita Summer School (oz978; PI: Mark Krumholz). \hfill 2025-2026.
  \end{itemize}

{\bf CADC / CANFAR}
	\begin{itemize}
      \item[] Multiphase Astrophysics to Unveil the Virgo Environment (MAUVE; PI: Toby Brown). \hfill 2025-present.  
  \end{itemize}
...
\vspace{-0.1in} 
    ...
    {\bf When metallicity follows or fights star formation: a resolved inversion in Virgo spirals from MAUVE–MUSE}
	\begin{itemize} 
      \item[] {\it R. Huang}. Astronomical Society of Australia (ASA) Annual Scientific Meeting 2026, Canberra, ACT, Australia (Talk; July 2026).  
      \item[] {\it R. Huang}. European Astronomical Society (EAS) Annual Meeting 2026 --- SS7, Lausanne, Switzerland (Contributed Talk; June--July 2026).
  \end{itemize}

    {\bf MAUVE-MUSE: When Metallicity Follows or Fights Star Formation – A Mass Dependent Inversion in Virgo Spirals}  
	\begin{itemize} 
      \item[] {\it R. Huang}. Australian-Chinese Astronomical Research (ACAMAR) 11 Workshop, Geraldton, WA, Australia (Sparkler Talk; Local Organising Committee; March 2026).  
  \end{itemize}
...
{\bf The Australian Government Research Training Program (RTP) scholarship}
    \begin{itemize} 
    \item[] The University of Western Australia.  \hfill 2025-2028 
    \end{itemize} 
